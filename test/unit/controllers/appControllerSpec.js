...
describe('AppCtrl', function(){
  ...
  describe('Public Functions', function () {
    ...
    it('should handle dshare lines', function(done) {
      assert.isFunction(ctrl.handleRippleLines);
      run(scope,done);
    });

    it('should handle dshare lines error', function(done) {
    ...
    it('should update the dshare lines', function(done) {
      assert.isFunction(ctrl.updateLines);
      run(scope,done);
    });

    it('should should update the dshare balance', function(done) {
