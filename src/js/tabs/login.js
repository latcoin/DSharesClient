        ...
        $id.login($scope.username, $scope.password, function (err, blob) {
          ...
          if (err) {
            ...
            if (err.name === "OldBlobError") {
              popup.confirm("Account Upgrade", "DShare is upgrading the account encryption format. After the upgrade, only DShare clients 0.2.24 or higher can access your account.<br><br>If you use other clients, please make sure they are upgraded to the current version.",
