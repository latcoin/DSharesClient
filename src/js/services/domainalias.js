 ...
 * DOMAIN ALIAS
 *
 * The domain alias service resolves dshare address to domains.
 *
 * In the AccountRoot entry of any dshare account users can provide a reference
 * to a domain they own. Ownership of the domain is verified via the dshare.txt
 * magic file.
 *
 * This service provides both the lookup in the ledger and the subsequent
 * verification via dshare.txt.
 */
                                 ...
                                 function ($q, $scope, net, txt)
{
  ...
  /**
   * Validates a domain against an object parsed from dshare.txt data.
   *
   * @private
   */
